...
releases:
	CIBW_BEFORE_BUILD="pip install cython; pip install misc/cythonpackage" CIBW_BUILD="cp39-manylinux_x86_64 cp310-manylinux_x86_64 cp311-manylinux_x86_64 cp312-manylinux_x86_64" cibuildwheel --platform linux
