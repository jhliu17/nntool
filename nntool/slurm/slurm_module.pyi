...
class SlurmFunction:
    ...
    **Exported Distributed Enviroment Variables**
    ...
    default_submit_fn_args: list[Any] | None = ...
    default_submit_fn_kwargs: dict[str, Any] | None = ...
    __doc__ = ...
...
def slurm_launcher(ArgsType: type[Any], parser: str | Callable = 'tyro', slurm_key: str = 'slurm', slurm_params_kwargs: dict = {}, slurm_submit_kwargs: dict = {}, slurm_task_kwargs: dict = {}, *extra_args, **extra_kwargs) -> Callable[[Callable[..., Any]], SlurmFunction]:
    ...
    **Exported Distributed Enviroment Variables**
    ...
    '''
def slurm_distributed_launcher(ArgsType: type[Any], parser: str | Callable = 'tyro', slurm_key: str = 'slurm', slurm_params_kwargs: dict = {}, slurm_submit_kwargs: dict = {}, slurm_task_kwargs: dict = {}, *extra_args, **extra_kwargs) -> SlurmFunction:
